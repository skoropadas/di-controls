import{a as Q}from"./chunk-QCTLYZ7J.js";import{a as X}from"./chunk-DO7RHM2D.js";import{a as K,b as H}from"./chunk-WTVINDDQ.js";import{a as B,b as G,c as Y,d as $,e as E,g as J,h as A,i as F,j as b}from"./chunk-CYVFRLOS.js";import"./chunk-FASSJ2TZ.js";import{a as q}from"./chunk-54ESS3WH.js";import"./chunk-7OD5W2O4.js";import{a as M}from"./chunk-RJEVQYMU.js";import{Ab as k,Ea as I,Fb as x,Ga as w,Ha as T,I as N,Jb as y,K as p,L as W,Na as u,Oa as j,Ta as m,Ua as i,Z as t,bc as cs,la as d,lb as f,ma as g,mb as V,na as z,oa as l,tb as r,wa as o,xa as c,ya as U,yb as C}from"./chunk-C3SKPK56.js";import{a as O,b as R,g as os}from"./chunk-JPKLQMV2.js";var ps=os(cs());var Z=(()=>{class s extends J{stringifyFn=String;constructor(){super({host:F({skipSelf:!0}),getValue:a=>a?this.stringifyFn(a):"",setValue:()=>null})}static \u0275fac=function(n){return new(n||s)};static \u0275dir=W({type:s,selectors:[["","diComboboxInput",""]],inputs:{stringifyFn:[0,"diComboboxInput","stringifyFn"]},standalone:!0,features:[m([A(s)]),d]})}return s})();var is=["*"];function ds(s,h){s&1&&(o(0,"div",2),T(1),c())}var v=(()=>{class s extends ${compareFn=(a,n)=>a===n;stringifyFn=String;opened=!1;constructor(){super({onChildControlChange:a=>{a instanceof E&&this.close()}})}open(){this.opened=!0}close(){this.opened=!1}static \u0275fac=function(n){return new(n||s)};static \u0275cmp=p({type:s,selectors:[["di-combobox"]],inputs:{compareFn:"compareFn",stringifyFn:"stringifyFn"},standalone:!0,features:[m([A(s),Y(s)]),d,i],ngContentSelectors:is,decls:2,vars:2,consts:[["diInputString","",3,"focus","blur","diComboboxInput"],["class","dropdown",4,"ngIf"],[1,"dropdown"]],template:function(n,e){n&1&&(w(),o(0,"input",0),I("focus",function(){return e.open()})("blur",function(){return e.touch()}),c(),g(1,ds,2,0,"div",1)),n&2&&(l("diComboboxInput",e.stringifyFn),t(),l("ngIf",e.opened))},dependencies:[r,V,Q,Z],styles:["[_nghost-%COMP%]{position:relative;display:inline-block;width:150px}[_nghost-%COMP%]   .dropdown[_ngcontent-%COMP%]{position:absolute;display:flex;flex-direction:column;width:100%;color:#000;border:1px solid #ccc;background:#fff;z-index:1}"],changeDetection:0})}return s})();var gs=["*"],S=(()=>{class s extends E{value;constructor(){super({host:F({optional:!0}),compare:N(G,{optional:!0})})}onClick(){this.check()}static \u0275fac=function(n){return new(n||s)};static \u0275cmp=p({type:s,selectors:[["di-option"]],hostVars:1,hostBindings:function(n,e){n&1&&I("click",function(){return e.onClick()}),n&2&&z("aria-checked",e.checked())},inputs:{value:"value"},standalone:!0,features:[d,i],ngContentSelectors:gs,decls:1,vars:0,template:function(n,e){n&1&&(w(),T(0))},styles:["[_nghost-%COMP%]{display:block;cursor:pointer}[_nghost-%COMP%]:hover{background-color:#e6f7ff}[aria-checked=true][_nghost-%COMP%]{background-color:#71e2ff}"],changeDetection:0})}return s})();function rs(s,h){if(s&1&&(o(0,"di-option",3),u(1),c()),s&2){let a=h.$implicit;l("value",a),t(),j(a)}}var ns=(()=>{class s{control=new k(null);items=H;static \u0275fac=function(n){return new(n||s)};static \u0275cmp=p({type:s,selectors:[["di-combobox-demo"]],standalone:!0,features:[i],decls:3,vars:3,consts:[[3,"control"],[3,"formControl"],[3,"value",4,"ngFor","ngForOf"],[3,"value"]],template:function(n,e){n&1&&(o(0,"di-model-info",0)(1,"di-combobox",1),g(2,rs,2,2,"di-option",2),c()()),n&2&&(l("control",e.control),t(),l("formControl",e.control),t(),l("ngForOf",e.items))},dependencies:[r,f,b,v,S,y,C,x],encapsulation:2,changeDetection:0})}return s})();function hs(s,h){if(s&1&&(o(0,"di-radio",3),u(1),c()),s&2){let a=h.$implicit;l("value",a),t(),j(a)}}var as=(()=>{class s{control=new k(null);items=H;static \u0275fac=function(n){return new(n||s)};static \u0275cmp=p({type:s,selectors:[["di-combobox-radio-demo"]],standalone:!0,features:[i],decls:3,vars:3,consts:[[3,"control"],[3,"formControl"],[3,"value",4,"ngFor","ngForOf"],[3,"value"]],template:function(n,e){n&1&&(o(0,"di-model-info",0)(1,"di-combobox",1),g(2,hs,2,2,"di-radio",2),c()()),n&2&&(l("control",e.control),t(),l("formControl",e.control),t(),l("ngForOf",e.items))},dependencies:[r,f,b,v,y,C,x,X],encapsulation:2,changeDetection:0})}return s})();function us(s,h){if(s&1&&(o(0,"di-option",3),u(1),c()),s&2){let a=h.$implicit;l("value",a),t(),j(a.name)}}var es=(()=>{class s{control=new k(null);items=K;compareFruits(a,n){return!!a&&!!n&&a.id===n.id}displayFruit(a){return a?.name??""}static \u0275fac=function(n){return new(n||s)};static \u0275cmp=p({type:s,selectors:[["di-combobox-object-demo"]],standalone:!0,features:[i],decls:3,vars:5,consts:[[3,"control"],[3,"formControl","compareFn","stringifyFn"],[3,"value",4,"ngFor","ngForOf"],[3,"value"]],template:function(n,e){n&1&&(o(0,"di-model-info",0)(1,"di-combobox",1),g(2,us,2,2,"di-option",2),c()()),n&2&&(l("control",e.control),t(),l("formControl",e.control)("compareFn",e.compareFruits)("stringifyFn",e.displayFruit),t(),l("ngForOf",e.items))},dependencies:[r,f,v,b,S,y,C,x],encapsulation:2,changeDetection:0})}return s})();var js={title:"Combobox",mdFile:"./index.md",category:B,demos:{ComboboxDemoComponent:ns,ComboboxRadioDemoComponent:as,ComboboxObjectDemoComponent:es},keyword:"ComboboxPage"},_=js;var ls=[];var ms={ComboboxDemoComponent:[{title:"combobox.component.ts",code:`<pre class="ngde hljs"><code lang="ts" class="hljs language-ts code-lines ngde"><span class="line ngde"><span class="hljs-keyword ngde">import</span> { <span class="hljs-title class_ ngde"><a href="https://angular.io/api/core/ChangeDetectionStrategy" class="ng-doc-code-anchor ngde" ngDocTooltip="External link the Angular documentation." class="ngde">ChangeDetectionStrategy</a></span>, <span class="hljs-title class_ ngde"><a href="https://angular.io/api/core/Component" class="ng-doc-code-anchor ngde" ngDocTooltip="External link the Angular documentation." class="ngde">Component</a></span>, <span class="hljs-title class_ ngde"><a href="https://angular.io/api/core/Input" class="ng-doc-code-anchor ngde" ngDocTooltip="External link the Angular documentation." class="ngde">Input</a></span> } <span class="hljs-keyword ngde">from</span> <span class="hljs-string ngde">'@angular/core'</span>;
...
</span><span class="line ngde">  <span class="hljs-comment ngde">// To convert value to string for <a href="https://angular.io/api/core/input" class="ng-doc-code-anchor ngde" ngDocTooltip="External link the Angular documentation." class="ngde">input</a></span>
</span><span class="line ngde">  <span class="hljs-meta ngde"><a href="https://angular.io/api/core/Input" class="ng-doc-code-anchor ngde" ngDocTooltip="External link the Angular documentation." class="ngde">@Input</a></span>()
...
</span><span class="line ngde">    <span class="hljs-comment ngde">// Provide this directive as a host to make it a host for the <a href="https://angular.io/api/core/input" class="ng-doc-code-anchor ngde" ngDocTooltip="External link the Angular documentation." class="ngde">input</a></span>
...
</span><span class="line ngde">  <span class="hljs-comment ngde">// We can use it to get value that will be displayed in <a href="https://angular.io/api/core/input" class="ng-doc-code-anchor ngde" ngDocTooltip="External link the Angular documentation." class="ngde">input</a></span>
...
</span><span class="line ngde">      <span class="hljs-comment ngde">// <a href="https://angular.io/api/core/Inject" class="ng-doc-code-anchor ngde" ngDocTooltip="External link the Angular documentation." class="ngde">Inject</a> host control (combobox) to get access to its <a href="https://angular.io/api/core/model" class="ng-doc-code-anchor ngde" ngDocTooltip="External link the Angular documentation." class="ngde">model</a></span>
...
</span><span class="line ngde">      <span class="hljs-comment ngde">// Convert selected value in combobox to string for <a href="https://angular.io/api/core/input" class="ng-doc-code-anchor ngde" ngDocTooltip="External link the Angular documentation." class="ngde">input</a></span>
...
</span><span class="line ngde">      <span class="hljs-comment ngde">// Clear combobox <a href="https://angular.io/api/core/model" class="ng-doc-code-anchor ngde" ngDocTooltip="External link the Angular documentation." class="ngde">model</a> when <a href="https://angular.io/api/core/input" class="ng-doc-code-anchor ngde" ngDocTooltip="External link the Angular documentation." class="ngde">input</a>'s changed</span>
...
</span><span class="line ngde">  <span class="hljs-attr ngde">selector</span>: <span class="hljs-string ngde">'<a href="https://angular.io/api/core/input" class="ng-doc-code-anchor ngde" ngDocTooltip="External link the Angular documentation." class="ngde">input</a>[diInputString]'</span>,
</span><span class="line ngde">  <span class="hljs-attr ngde">standalone</span>: <span class="hljs-literal ngde">true</span>,
</span><span class="line ngde">})
...
</span><span class="line ngde">      <span class="hljs-attr ngde">withNativeElementSupport</span>: <span class="hljs-literal ngde">true</span>,
</span><span class="line ngde">    });
</span><span class="line ngde">  }
</span><span class="line ngde">
</span><span class="line ngde">  <span class="hljs-meta ngde"><a href="https://angular.io/api/core/HostListener" class="ng-doc-code-anchor ngde" ngDocTooltip="External link the Angular documentation." class="ngde">@HostListener</a></span>(<span class="hljs-string ngde">'<a href="https://angular.io/api/core/input" class="ng-doc-code-anchor ngde" ngDocTooltip="External link the Angular documentation." class="ngde">input</a>'</span>)
...
</span><span class="line ngde">  <span class="hljs-attr ngde">host</span>: {
</span><span class="line ngde">    <span class="hljs-string ngde">'[attr.aria-checked]'</span>: <span class="hljs-string ngde">'checked()'</span>,
</span><span class="line ngde">  },
</span><span class="line ngde">})
...
</span><span class="line ngde">      <span class="hljs-comment ngde">// <a href="https://angular.io/api/core/Inject" class="ng-doc-code-anchor ngde" ngDocTooltip="External link the Angular documentation." class="ngde">Inject</a> host control to get access to its <a href="https://angular.io/api/core/model" class="ng-doc-code-anchor ngde" ngDocTooltip="External link the Angular documentation." class="ngde">model</a></span>
</span><span class="line ngde">      <span class="hljs-attr ngde">host</span>: <span class="hljs-title function_ ngde"><a href="/api/di-controls/functions/injectHostControl3" class="ng-doc-code-anchor ngde" data-link-type="Function" class="ngde">injectHostControl</a></span>({ <span class="hljs-attr ngde">optional</span>: <span class="hljs-literal ngde">true</span> }),
...
</span><span class="line ngde"><span class="hljs-string ngde">      &#x3C;<a href="https://angular.io/api/core/input" class="ng-doc-code-anchor ngde" ngDocTooltip="External link the Angular documentation." class="ngde">input</a> type="radio" [checked]="checked()" (change)="check(); touch()" /></span>
</span><span class="line ngde"><span class="hljs-string ngde">      &#x3C;ng-content>&#x3C;/ng-content></span>
</span><span class="line ngde"><span class="hljs-string ngde">    &#x3C;/label></span>
</span><span class="line ngde"><span class="hljs-string ngde">  \`</span>,
</span><span class="line ngde">  <span class="hljs-attr ngde">styles</span>: [
...
</span><span class="line ngde"><span class="hljs-string ngde">    &#x3C;<a href="https://angular.io/api/core/input" class="ng-doc-code-anchor ngde" ngDocTooltip="External link the Angular documentation." class="ngde">input</a> diInputString [diComboboxInput]="stringifyFn" (focus)="open()" (blur)="touch()" /></span>
</span><span class="line ngde"><span class="hljs-string ngde"></span>
</span><span class="line ngde"><span class="hljs-string ngde">    &#x3C;div class="dropdown" *ngIf="opened"></span>
</span><span class="line ngde"><span class="hljs-string ngde">      &#x3C;ng-content>&#x3C;/ng-content></span>
</span><span class="line ngde"><span class="hljs-string ngde">    &#x3C;/div></span>
