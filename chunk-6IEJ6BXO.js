import{a as K}from"./chunk-M6OTPOWX.js";import{a as Q}from"./chunk-ECGVIAFH.js";import{a as J,b as H}from"./chunk-WTVINDDQ.js";import{a as q,b as B,c as G,d as Y,e as E,g as $,h as A,i as F,j as D}from"./chunk-EG77LTH3.js";import"./chunk-2TQ2H6IW.js";import{a as V}from"./chunk-V6VY7XAX.js";import"./chunk-HYS46HGF.js";import{a as M}from"./chunk-B6UGVOB2.js";import{Da as I,Eb as x,Fa as w,Ga as T,I as N,Ib as y,K as o,L as W,Ma as u,Na as j,Sa as m,Ta as i,Z as t,ac as ps,ka as d,kb as f,la as g,lb as U,na as l,sb as r,va as p,wa as c,xa as z,xb as C,zb as k}from"./chunk-3OP3UFZB.js";import{a as O,b as R,g as os}from"./chunk-JPKLQMV2.js";var ts=os(ps());var X=(()=>{class s extends ${stringifyFn=String;constructor(){super({host:F({skipSelf:!0}),getValue:a=>a?this.stringifyFn(a):"",setValue:()=>null})}static \u0275fac=function(n){return new(n||s)};static \u0275dir=W({type:s,selectors:[["","diComboboxInput",""]],inputs:{stringifyFn:[0,"diComboboxInput","stringifyFn"]},standalone:!0,features:[m([A(s)]),d]})}return s})();var cs=["*"];function is(s,h){s&1&&(p(0,"div",2),T(1),c())}var v=(()=>{class s extends Y{compareFn=(a,n)=>a===n;stringifyFn=String;opened=!1;constructor(){super({onChildControlChange:a=>{a instanceof E&&this.close()}})}open(){this.opened=!0}close(){this.opened=!1}static \u0275fac=function(n){return new(n||s)};static \u0275cmp=o({type:s,selectors:[["di-combobox"]],inputs:{compareFn:"compareFn",stringifyFn:"stringifyFn"},standalone:!0,features:[m([A(s),G(s)]),d,i],ngContentSelectors:cs,decls:2,vars:2,consts:[["diInputString","",3,"focus","blur","diComboboxInput"],["class","dropdown",4,"ngIf"],[1,"dropdown"]],template:function(n,e){n&1&&(w(),p(0,"input",0),I("focus",function(){return e.open()})("blur",function(){return e.touch()}),c(),g(1,is,2,0,"div",1)),n&2&&(l("diComboboxInput",e.stringifyFn),t(),l("ngIf",e.opened))},dependencies:[r,U,K,X],styles:["[_nghost-%COMP%]{position:relative;display:inline-block;width:150px}[_nghost-%COMP%]   .dropdown[_ngcontent-%COMP%]{position:absolute;display:flex;flex-direction:column;width:100%;color:#000;border:1px solid #ccc;background:#fff;z-index:1}"],changeDetection:0})}return s})();var ds=["*"],S=(()=>{class s extends E{value;constructor(){super({host:F({optional:!0}),compare:N(B,{optional:!0})})}onClick(){this.check()}static \u0275fac=function(n){return new(n||s)};static \u0275cmp=o({type:s,selectors:[["di-option"]],hostBindings:function(n,e){n&1&&I("click",function(){return e.onClick()})},inputs:{value:"value"},standalone:!0,features:[d,i],ngContentSelectors:ds,decls:1,vars:0,template:function(n,e){n&1&&(w(),T(0))},styles:["[_nghost-%COMP%]{display:block;cursor:pointer}[_nghost-%COMP%]:hover{background-color:#e6f7ff}[aria-checked=true][_nghost-%COMP%]{background-color:#71e2ff}"],changeDetection:0})}return s})();function gs(s,h){if(s&1&&(p(0,"di-option",3),u(1),c()),s&2){let a=h.$implicit;l("value",a),t(),j(a)}}var ss=(()=>{class s{control=new k(null);items=H;static \u0275fac=function(n){return new(n||s)};static \u0275cmp=o({type:s,selectors:[["di-combobox-demo"]],standalone:!0,features:[i],decls:3,vars:3,consts:[[3,"control"],[3,"formControl"],[3,"value",4,"ngFor","ngForOf"],[3,"value"]],template:function(n,e){n&1&&(p(0,"di-model-info",0)(1,"di-combobox",1),g(2,gs,2,2,"di-option",2),c()()),n&2&&(l("control",e.control),t(),l("formControl",e.control),t(),l("ngForOf",e.items))},dependencies:[r,f,D,v,S,y,C,x],encapsulation:2,changeDetection:0})}return s})();function rs(s,h){if(s&1&&(p(0,"di-radio",3),u(1),c()),s&2){let a=h.$implicit;l("value",a),t(),j(a)}}var ns=(()=>{class s{control=new k(null);items=H;static \u0275fac=function(n){return new(n||s)};static \u0275cmp=o({type:s,selectors:[["di-combobox-radio-demo"]],standalone:!0,features:[i],decls:3,vars:3,consts:[[3,"control"],[3,"formControl"],[3,"value",4,"ngFor","ngForOf"],[3,"value"]],template:function(n,e){n&1&&(p(0,"di-model-info",0)(1,"di-combobox",1),g(2,rs,2,2,"di-radio",2),c()()),n&2&&(l("control",e.control),t(),l("formControl",e.control),t(),l("ngForOf",e.items))},dependencies:[r,f,D,v,y,C,x,Q],encapsulation:2,changeDetection:0})}return s})();function hs(s,h){if(s&1&&(p(0,"di-option",3),u(1),c()),s&2){let a=h.$implicit;l("value",a),t(),j(a.name)}}var as=(()=>{class s{control=new k(null);items=J;compareFruits(a,n){return!!a&&!!n&&a.id===n.id}displayFruit(a){return a?.name??""}static \u0275fac=function(n){return new(n||s)};static \u0275cmp=o({type:s,selectors:[["di-combobox-object-demo"]],standalone:!0,features:[i],decls:3,vars:5,consts:[[3,"control"],[3,"formControl","compareFn","stringifyFn"],[3,"value",4,"ngFor","ngForOf"],[3,"value"]],template:function(n,e){n&1&&(p(0,"di-model-info",0)(1,"di-combobox",1),g(2,hs,2,2,"di-option",2),c()()),n&2&&(l("control",e.control),t(),l("formControl",e.control)("compareFn",e.compareFruits)("stringifyFn",e.displayFruit),t(),l("ngForOf",e.items))},dependencies:[r,f,v,D,S,y,C,x],encapsulation:2,changeDetection:0})}return s})();var us={title:"Combobox",mdFile:"./index.md",category:q,demos:{ComboboxDemoComponent:ss,ComboboxRadioDemoComponent:ns,ComboboxObjectDemoComponent:as},keyword:"ComboboxPage"},_=us;var es=[];var js={ComboboxDemoComponent:[{title:"combobox.component.ts",code:`<pre class="ngde hljs"><code lang="ts" class="hljs language-ts code-lines ngde"><span class="line ngde"><span class="hljs-keyword ngde">import</span> { <span class="hljs-title class_ ngde"><a href="https://angular.io/api/core/ChangeDetectionStrategy" class="ng-doc-code-anchor ngde" ngDocTooltip="External link the Angular documentation." class="ngde">ChangeDetectionStrategy</a></span>, <span class="hljs-title class_ ngde"><a href="https://angular.io/api/core/Component" class="ng-doc-code-anchor ngde" ngDocTooltip="External link the Angular documentation." class="ngde">Component</a></span>, <span class="hljs-title class_ ngde"><a href="https://angular.io/api/core/Input" class="ng-doc-code-anchor ngde" ngDocTooltip="External link the Angular documentation." class="ngde">Input</a></span> } <span class="hljs-keyword ngde">from</span> <span class="hljs-string ngde">'@angular/core'</span>;
